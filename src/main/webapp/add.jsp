...
<body>
	...
	<div class="wrap">
		...
		<form action="insert.do" method="post"
			...
			<input type="hidden" name="auction_id" value="0"/>
				...
				<dl>
					...
					<dd>
						<label>结束时间：</label> <input type="text" class="inputh lf"
							name="auction_end_time" /> <input type="hidden"
							class="inputh lf" name="auction.auction_pic" value="assd" />
						<div class="lf red laba">格式：2010-05-06 16:30:00</div>
					</dd>
					<dd class="dds">
						<label>拍卖品图片：</label>
						<div class="lf salebd">
							<a href="#"><img src="images/ad20.jpg" width="100"
								height="100" /></a>
						</div>
					...
					<dd class="dds">
						<label>描述：</label> <input type="text" name="auction_desc" />
